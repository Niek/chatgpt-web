<script context="module" lang="ts">
  ...
  import { type supportedChatModelKeys } from './Models.svelte'
...
export interface ResponseAlteration {
  type: 'prompt' | 'replace'
  match: string
  replace: string
}
...
export interface SettingSelectNumber {
  type: 'select-number'
  options: SelectOption[]
}
